...
/**
 * MD5工具类
 * https://github.com/kingchn/meteor-framework/blob/master/util/src/main/java/cn/meteor/module/util/security/MD5Utils.java
 */
public class MD5Utils {
    ...
    public static byte[] md5Digest(byte[] data) throws Exception {
        MessageDigest md = MessageDigest.getInstance("MD5"); // MD5 is 16 bit message digest
